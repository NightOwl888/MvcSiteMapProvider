...
namespace MvcSiteMapProvider.Resources {
    ...
    internal class Messages {
        ...
        /// <summary>
        ///   Looks up a localized string similar to ASP.NET session state is required to use the default SessionCacheKeyGenerator. You can enable it by setting &lt;sessionState mode=&quot;InProc&quot;/&gt; or use one of the out-of-process modes. We recommend using a machine key when using session state whether you are using an in process or out of process session state provider (see MSDN for documentation on setting up a machine key).
        ///
        ///Alternatively, you may implement ISessionCacheKeyGenerator yourself and use a cookie to track your user session key rather than using ASP. [rest of string was truncated]&quot;;.
        /// </summary>
        internal static string SessionStateRequired {
            get {
                return ResourceManager.GetString("SessionStateRequired", resourceCulture);
            }
        }
