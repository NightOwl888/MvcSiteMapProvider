...
namespace MvcSiteMapProvider.Tests.Unit.Xml.Sitemaps
{
    [TestFixture]
    public class AutomaticSitemapsPagingStrategyTest
    {
        #region SetUp / TearDown

        private Mock<IUrlEntryProviderPagingInstructionFactory> urlEntryProviderPagingInstructionFactory = null;
        ...
        public void Init()
        {
            urlEntryProviderPagingInstructionFactory = new Mock<IUrlEntryProviderPagingInstructionFactory>();
            ...
            this.urlEntryProviderPagingInstructionFactory
                ...
                {
                    var instruction = new Mock<IUrlEntryProviderPagingInstruction>();
        ...
        public void Dispose()
        {
            urlEntryProviderPagingInstructionFactory = null;
        ...
        private ISitemapsPagingStrategy NewAutomaticSitemmapsPagingStrategy_TestCase1()
        {
            ...
            return new AutomaticSitemapsPagingStrategy(new IUrlEntryProvider[] 
            {
                urlEntryProvider1.Object,
                urlEntryProvider2.Object,
                urlEntryProvider3.Object
            }, this.urlEntryProviderPagingInstructionFactory.Object);
        }

        // 5 providers with 25,000 records each, 35,000 maximum per page
        private ISitemapsPagingStrategy NewAutomaticSitemmapsPagingStrategy_TestCase2()
        {
